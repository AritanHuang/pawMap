import{S as m}from"./bootstrap.min-4cf75e1e.js";import{a as f,b as g}from"./axios-4008c28b.js";function b(e){return e.substring(3,6)}function q(){window.scrollTo({top:0,behavior:"smooth"})}const v=document.querySelector("#hospital-list"),k=document.querySelector("#pagination");let p=[],d=[],y=0,h=12,n=1,u=[];function w(){f.get(`${g}/hospitals`).then(function(e){p=e.data,y=p.length,x(1),P()}).catch(function(e){console.log(e)})}w();function $(){const e=document.querySelector("#hospital-search");let l="",t=0;d.forEach(function(a){let s="";if(a.機構地址){let o=a.機構地址;s=b(o)}l+=` <li class="col-12 col-sm-6 col-lg-4 ">
