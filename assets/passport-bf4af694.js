import{a as o,b as r}from"./axios-4008c28b.js";import{S as c}from"./bootstrap.min-18d6e209.js";import{s as d,d as t,c as g}from"./utils-7347e35d.js";const m=localStorage.getItem("token"),a=localStorage.getItem("userId");let e;function f(){m||a?o.get(`${r}/users/${a}`).then(function(s){e=s.data,b()}).catch(function(s){console.log(s)}):c.fire({icon:"error",title:"請先登入或註冊",text:"必須是會員才能使用此功能",footer:'<a href="login.html">登入</a>'})}f();function b(){const s=document.querySelector("#passport-content");let p=d(e.address),n=t(e).petGender,i=t(e).isSpayed,l=g(e.petBirthday);e&&(s.innerHTML=`<div class="d-flex flex-column flex-lg-row 
        align-items-center
