import{t as h,a as i,b as o,S as d,u as g}from"./axios-2d2df78c.js";import{s as q,a as b}from"./utils-77fb7ba4.js";const y=document.querySelector("#hospital-list"),k=document.querySelector("#pagination");let m=[],f=[],x=0,v=12,r=1,$=[];function w(){i.get(`${o}/hospitals`).then(function(t){m=t.data,x=m.length,L(1),E()}).catch(function(t){console.log(t)})}w();function S(){A();const t=document.querySelector("#hospital-search");let l="",a=0;f.forEach(function(e){let s="";if(e.機構地址){let c=e.機構地址;s=b(c)}l+=` <li class="col-12 col-sm-6 col-lg-4 ">
        ...
        </li>`,a++}),y.innerHTML=l,a===0&&d.fire("很抱歉，本區域尚無資料"),t.textContent=`本次搜尋共${a}筆`}function C(t,l){let a="";const e=Math.ceil(t/l),s=5;let c=1,u=e;if(e>s){const n=Math.floor(s/2);c=r-n,u=r+n,c<1?(c=1,u=s):u>e&&(u=e,c=e-s+1)}r===1?a+=`<li class="page-item">
    ...
    </li>`;for(let n=c;n<=u;n++)n===r?a+=`<li class="page-item"><a class="page-link active" data-id="${n} " href="#">${n}</a></li>`:a+=`<li class="page-item"><a class="page-link" data-id="${n}" href="#">${n}</a></li>`;r===e?a+=`<li class="page-item">
